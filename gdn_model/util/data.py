...
def eval_scores(scores, true_scores, th_steps, return_thresold=False):
    '''this function is the evaluation function and computing the F1 score under different thresholds. Best f1 will be used to select the threshold 
    ...
    for i in range(th_steps):
        cur_pred = scores_sorted > th_vals[i] * len(scores) # len cur_pred = 44986
